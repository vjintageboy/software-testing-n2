                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('class-size-coefficients.update', $coefficient) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="valid_from" class="form-control" id="valid_from" value="{{ old('valid_from', $coefficient->valid_from) }}" required>
                        </div>
                        <div class="form-group">
                            <label for="valid_to">Ngày hết hiệu lực</label>
                            <input type="date" name="valid_to" class="form-control" id="valid_to" value="{{ old('valid_to', $coefficient->valid_to) }}">
